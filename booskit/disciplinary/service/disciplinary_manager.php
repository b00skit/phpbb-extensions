...
class disciplinary_manager
{
	...
	public function add_record($user_id, $disciplinary_type_id, $issue_date, $reason, $evidence, $issuer_user_id, $reason_uid = '', $reason_bitfield = '', $reason_options = 7, $evidence_uid = '', $evidence_bitfield = '', $evidence_options = 7)
	{
		$sql_ary = [
			'user_id' => (int) $user_id,
			...
			'reason_bbcode_uid' => $reason_uid,
			'reason_bbcode_bitfield' => $reason_bitfield,
			'reason_bbcode_options' => $reason_options,
			'evidence_bbcode_uid' => $evidence_uid,
			'evidence_bbcode_bitfield' => $evidence_bitfield,
			'evidence_bbcode_options' => $evidence_options,
		];
	...
	public function update_record($record_id, $disciplinary_type_id, $issue_date, $reason, $evidence, $reason_uid = '', $reason_bitfield = '', $reason_options = 7, $evidence_uid = '', $evidence_bitfield = '', $evidence_options = 7)
	{
		$sql_ary = [
			'disciplinary_type_id' => $disciplinary_type_id,
			'issue_date' => (int) $issue_date,
