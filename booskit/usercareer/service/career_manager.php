...
class career_manager
{
	...
	public function add_note($user_id, $career_type_id, $note_date, $description, $issuer_user_id, $bbcode_uid = '', $bbcode_bitfield = '', $bbcode_options = 7)
	{
		$sql_ary = [
			'user_id' => (int) $user_id,
	...
	public function update_note($note_id, $career_type_id, $note_date, $description, $bbcode_uid = '', $bbcode_bitfield = '', $bbcode_options = 7)
	{
		$sql_ary = [
			'career_type_id' => $career_type_id,
			'note_date' => (int) $note_date,
