...
class main
{
	...
	public function add_award($user_id)
	{
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			$this->log->add('mod', $user_id, $this->user->ip, 'LOG_AWARD_ADDED', time(), array($user_row));
	...
	public function remove_award($award_id)
	{
		...
		if (confirm_box(true))
		{
			...
			$this->log->add('mod', $target_user_id, $this->user->ip, 'LOG_AWARD_REMOVED', time(), array($user_row));
